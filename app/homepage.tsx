    ...
    <div className="site-home">
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation">
          <a href={base}>Home</a>
          <a href="#episode-library">Episodes</a>
          <a href="#atlas">Atlas</a>
          <a href="#about-the-show">About Dan</a>
          <a href="#footer-links">Merch</a>
        </nav>
      ...
      <main>
        ...
        <section className="subscribe-section" id="subscribe">
          <div className="newsletter-panel"><p className="home-eyebrow">STAY ON THE PATH</p><h2>New stories, delivered when they&apos;re ready.</h2><p>AWeber will power this email sign-up when the site launches.</p><div className="email-placeholder"><span>Your email address</span><b>SIGN UP →</b></div></div>
          <div className="listen-panel"><p className="home-eyebrow">LISTEN WHERE YOU LIKE</p><h2>Subscribe to the podcast.</h2><div>{listeningLinks.map((link) => <a key={link.label} href={link.href} target="_blank" rel="noreferrer">{link.label}<b>↗</b></a>)}</div></div>
        </section>
      </main>

      <footer className="site-footer" id="footer-links">
        <div className="footer-column"><p className="footer-label">EXPLORE</p><a href={base}>Home</a><a href="#episode-library">Episodes</a><a href="#articles">Articles</a><a href="#atlas" id="atlas">Atlas</a><span>Merch</span></div>
